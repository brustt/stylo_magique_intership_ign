...
class CDDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage):
        ...
        self.train = BiTemporalDataset(name=self.name, dtype="train", transform=DefaultTransform())
        self.val = BiTemporalDataset(name=self.name, dtype="val", transform=DefaultTransform())
        self.test = BiTemporalDataset(name=self.name, dtype="test", transform=DefaultTransform())
