...
class PromptToImageFusion(nn.Module):
    def __init__(self,   
        transformer_dim: int,
    ...
    def forward(self,
        ...
        pos_src = pos_src.unsqueeze(0).expand(src.size(0), -1, -1, -1, -1)
        ...
        # Run the transformer
        tokens, src = self.transformer(src, pos_src, tokens)
...
class TwoWayTransformer(nn.Module):
    def __init__(
        ...
        # self.norm_final_attn = LayerNorm2dScale(embedding_dim)
